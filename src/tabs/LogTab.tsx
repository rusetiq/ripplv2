    ...
    >
      ...
      >
        ...
        <button
          ...
          className="w-full py-4 rounded-full bg-white text-black font-body text-[13px] font-semibold shadow-lg hover:bg-white/95 active:scale-[0.98] transition-all flex items-center justify-center gap-2"
        >
          <Camera size={16} />
