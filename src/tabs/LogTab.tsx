        ...
        {categories.map(cat => {
          ...
          return (
            <button
              ...
              className={`relative flex items-center gap-2 px-4 py-2.5 rounded-full shrink-0 text-[12px] font-medium transition-all ${isActive
            ...
            >
              {isActive && (
                <motion.div
                  ...
                  className={`absolute inset-0 rounded-full ${cat.id === 'transport' ? 'bg-[#2563eb]' :
